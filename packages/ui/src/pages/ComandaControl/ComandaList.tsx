...
export const ComandaList: React.FC<ComandaListProps> = ({ comandas, onSelectComanda, calculateTotal }) => {
  return (
    <div className="comanda-list">
      <h2>Comandas Abertas</h2>
      {comandas.map((comanda) => (
        <div key={comanda.id} className="comanda-item" onClick={() => onSelectComanda(comanda)}>
