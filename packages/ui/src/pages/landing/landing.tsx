			...
			<main className="flex-grow container mx-auto px-4 py-8">
				<section className="text-center mb-16">
					<h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
						Conquiste, Retenha e Fidelize Clientes
					</h1>
					<p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
						Solução completa para sua empresa crescer: app fidelidade, portal do
						cliente, PDV, automações e diversas ferramentas de marketing.
					</p>
					<button
				...
				<section className="grid md:grid-cols-2 gap-8 mb-16">
					<div className="bg-white rounded-lg shadow-lg p-8 transition duration-300 ease-in-out hover:shadow-xl">
						<img
							src="/assets/icon-fidelidade.png"
						...
						<p className="text-gray-600">
							Plataforma completa com portal e aplicativo fidelidade para você
							conquistar, reter e fidelizar seus clientes.
						</p>
					</div>
					<div className="bg-white rounded-lg shadow-lg p-8 transition duration-300 ease-in-out hover:shadow-xl">
						<img
							src="/assets/icon-marketing.png"
							alt="Marketing Automatizado"
							className="w-16 h-16 mb-4"
						/>
						<h2 className="text-2xl font-semibold text-gray-800 mb-4">
						...
						<p className="text-gray-600">
							Campanhas personalizadas e automatizadas para aumentar a
							recorrência mantendo contato com os clientes via WhatsApp, SMS e
							E-mail.
						</p>
					</div>
				</section>
				...
				<section className="text-center mb-16">
					<h2 className="text-3xl font-bold text-gray-800 mb-4">
						Gerencie Comandas com Facilidade
					</h2>
					<p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
						Nosso sistema de controle de comandas para restaurantes simplifica
						suas operações e melhora a experiência do cliente.
					</p>
					<button
