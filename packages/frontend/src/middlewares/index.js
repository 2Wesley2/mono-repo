...
const getValidEncryptionKey = (secret) => {
  ...
  if (decodedKey.length !== 32) {
    throw new Error('A chave decodificada deve ter exatamente 32 bytes (256 bits) para HS256');
  }
...
const accessController = new AccessController(tokenValidator, roleExtractor, tokenSigner);
